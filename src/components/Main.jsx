  ...
  return (
    <main className="bg-[#F9F9F9]">
      <section className="sm:pt-12 md:py-28 flex sm:flex-col-reverse md:flex-row justify-center items-center gap-10  xl:max-w-[80vw] md:max-w-[90vw] lg:gap-38 md:gap-28 sm:m-auto ">
        ...
        <div className="sm:w-[300px] sm:h-[300px] md:w-[350px] md:h-[350px]  lg:w-[400px] lg:h-[400px] rounded-full flex justify-center items-center overflow-hidden ">
          <img
            className="sm:w-[300px] sm:h-[300px] md:w-[350px] md:h-[350px] rounded-full"
            src={profileImg}
            alt="profile"
          />
        </div>
